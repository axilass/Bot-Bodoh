...
/////////////////
const BotName = 'Bot-Bodoh'; 
const instagram = 'https://www.instagram.com/axilas.game'; 
const telegram = 'https://t.me/Axilas12'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UC-Cc9zkScRGP6ONULeETtZQ';
//const grupch1 = 'https://chat.whatsapp.com/F7Bi8RrqvJoJe54MQVF6lU'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Taufik')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Taufik`)
})
